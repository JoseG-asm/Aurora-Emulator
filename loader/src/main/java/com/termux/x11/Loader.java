...
public class Loader {
    /**
     * Command-line entry point. It is pretty simple. 1. Check if application is installed. 2. Check
     * if target apk's signature matches stored hash to prevent running code of potentially replaced
     * malicious apk. 3. Load target apk code with `PathClassLoader` and start target's main
     * function.
     *
     * <p>This way we can make this loader version-agnostic and keep it secure. All application
     * logic is located in target apk.
     *
