...
import static com.project_aurora.emu.input.InputStub.*;
...
public final class InputEventSender {
    ...
    public boolean sendKeyEvent(View v, KeyEvent e) {
        ...
        if (pointerCapture && keyCode == KEYCODE_ESCAPE && !pressed) {
            ...
            if (KeyInterceptor.keyCaptureOnlyWhenPointerIntercepted && XserverActivity.getInstance().dexMetaKeyCapture)
                SamsungDexUtils.dexMetaKeyCapture(XserverActivity.getInstance(), false);
        }
